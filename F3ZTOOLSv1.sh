...
echo
echo $red"##########################$green" MONGGO "$red###########################"
echo $yellow
figlet -f future "==[Bojonegoro Cyber Secutity]=="
echo
echo $red"##########################$green" PINARAK "$red###########################"
echo
...
echo $indigo"=============================================================="
echo
echo $white "╭─"$yellow"[B.C.S]"$cyan"~/F3Z"$white
read -p " ╰─$ "  apaan
echo
if [ $apaan = "A" ] || [ $apaan = "a" ]
then
...
echo
echo $red "Simpem SC Neng Memory Internal Neng Njobo Folder Cuk:) "
echo
...
echo $green "╭─"$blue"[B.C.S]"$cyan"~/F3Z"$white
read -p " ╰─$ "  target
echo
echo $red "Lebokno Script!!! "
echo $green "╭─"$blue"[B.C.S]"$cyan" ~/Jeneng SCKudu(index.html)"$white
read -p " ╰─$ "  script
...
echo
echo $red
toilet -f future "Auto Deface 1 Ndonyo" | lolcat
echo $cyan "Deface Masal 1 Desa cuk;)"
echo
echo $red"###"$blue" ctrl + c to quit"$red" ###"
echo
echo
echo
echo "Lebokno Script Cuk !!!!"
...
echo
echo
toilet -f future "   Informasi Tools Iki:)" | lolcat
echo $red"##########################$green" MONGGO "$red###########################"
echo $green"Author  : F3Z / F-RREL			"
echo $purple"Gthub   : https://github.com/xF3Zx"
echo $white"Blog    : https://f3zid.blogspot.com"
echo
echo $yellow"                         Maturnuwon To :"
echo
echo $cyan"[+] MR.Nothing & Z3X "
echo $cyan"[+] F3R "
echo $cyan"[+] All member [Bojonegoro Cyber Security] "
echo $red"##########################$green" PINARAK "$red###########################"
...
if [ $apaan = "Q" ] || [ $apaan = "q" ]
then
echo " Maturnuwon Sampun Ndamel Tools Kulo Tod :) "
exit
clear
fi
